          ...
          <div className="flex items-center gap-2 z-30">
            ...
            <div className="shrink-0 flex items-center">
              <Link href="/" className="flex items-center gap-2 group">
                ...
                <span className="hidden md:block font-bold text-xl tracking-tight text-white drop-shadow-md group-hover:text-yellow-300 transition-colors">
                  Pokedex
                </span>
              </Link>
            </div>
            ...
            {menuItems.map((item) => (
              <Link
                ...
                className={`px-4 py-2 rounded-full text-sm font-bold transition-all border-2 ${
                  pathname === item.href
                    ? "bg-red-700 text-yellow-300 border-yellow-300/50"
                    : "text-white hover:text-yellow-300 hover:bg-red-700/50 border-transparent hover:border-yellow-300/50"
                }`}
              >
                {item.name}
              </Link>
